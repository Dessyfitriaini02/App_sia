  ...
  <tr>
   ...
   <td>
    ...
    <a href="" class="text-decoration-none">
     ...
     <!-- Modal -->
     <div class="modal fade" id="editPenjualan" tabindex="-1"
...
id="exampleModalLabel">Edit Data Penjualan</h1>
...
name="invoice" value="PJ110324" disabled>
    </div>
     <div class="col-md-4">
     <label for="tanggal" class="formlabel">Tanggal</label>
      <input type="date" class="form-control"
name="tanggal" value="2024-11-03">
    </div>
    <div class="col-md-4">
    <label for="barang" class="formlabel">Barang</label>
    <select name="barang" class="form-select">
    <option value="1" selected>Laptop 
Acer</option>
     <option value="2">Komputer (PC)</option>
     </select>
     </div>
...
name="harga" value="10000000">
     ...
     <span class="input-group-text">Rp.</span>
     <input type="number" class="form-control"
name="total" value="30000000" disabled>
     </div>
     </div>
     </div>
     <div class="row">
